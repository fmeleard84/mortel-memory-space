          ...
          <div className="flex flex-col lg:flex-row items-start gap-20">
            ...
            <div className="flex-1 flex flex-col gap-8">
              ...
              <div className="flex flex-col sm:flex-row items-start gap-6">
                <button className="px-6 py-2.5 bg-mortel-blue text-white text-base font-normal font-inter leading-normal rounded-none transition-all duration-200 hover:rounded-[5px] hover:shadow-[0_0_10px_rgba(255,255,255,0.30)]">
                  Préparer
                </button>
