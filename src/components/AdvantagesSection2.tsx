...
const AdvantagesSection2 = () => {
  return (
    <section className="w-full bg-[#1F1B23] overflow-hidden flex flex-col justify-start items-start">
      <div className="w-full px-16 py-28 flex flex-col justify-start items-center gap-20">
        <div className="w-full max-w-[1280px] flex flex-col justify-start items-start gap-20">
          <div className="w-full flex justify-start items-center gap-20">
            ...
            <div className="flex-1">
              <img 
                className="w-full h-[640px] rounded-[28px] object-cover" 
