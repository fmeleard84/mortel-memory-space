...
const NewFAQ = () => {
  ...
  return <section className="w-full bg-mortel-dark">
          ...
          <div className="flex flex-col lg:flex-row items-start gap-20">
            <div className="w-full lg:w-[500px] flex flex-col gap-8">
              <div className="flex flex-col gap-6">
                ...
                <p className="text-white text-lg font-inter font-normal leading-[27px]">Nous répondons à vos questions pour vous accompagner au mieux.</p>
              </div>
            ...
            <div className="flex-1 border-b border-white/20">
              <div className="flex flex-col">
                {faqItems.map((item, index) => <div key={index} className="border-t border-white/20">
                    <button onClick={() => toggleItem(index)} className="w-full py-5 flex items-center justify-between gap-6 text-left hover:bg-white/5 transition-colors">
                    ...
                    {openItems.includes(index) && <div className="pb-6">
