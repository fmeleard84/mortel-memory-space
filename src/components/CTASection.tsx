        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <a
              ...
              className="flex items-center justify-center space-x-3 bg-white text-primary px-8 py-4 hover:bg-gray-50 transition-all duration-200 font-semibold text-lg shadow-lg"
            >
              <Phone size={20} />
              <span>Appel gratuit immédiat</span>
            </a>
            
            <button className="flex items-center justify-center space-x-3 border-2 border-white text-white px-8 py-4 hover:bg-white/10 transition-all duration-200 font-semibold text-lg">
              <Calendar size={20} />
